...
Install ADB and add it to your path, there are tons of guides for this, so I won't detail it here. Next, find your Fire TV's IP address in _Settings > System > About > Network_. You can then connect to your Fire TV by running the following commands:
...
Applications installed through ADB won't be shown on the launcher, but are accessible through _Settings > Applications_.
...
- _...I'll add more later as I test them_
