  ...
  return (
    <>
      ...
      <div className="flex justify-center pb-12 md:pb-20">
        ...
        <svg className="w-8 h-8 md:w-12 md:h-12 text-zinc-300 dark:text-cyan-900" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 100 100" role="img" aria-label="Pizza" title="Thank you for eating pizza.">
