  ...
  return (
    <Layout location={location} header={header}>
      <section className="prose-all prose-indigo mx-auto lg:-rotate-2 shadow-layered-light bg-white dark:shadow-layered-dark dark:bg-slate-800 px-6 py-4 lg:px-8 rounded-xl lg:rounded-3xl">
        ...
        <p>
          I'm a weird nerd that tinkers in all things computers. Professionally,
          I'm a web app developer, but I also do a lot of UI design, server
          setup, and really anything computery. I have some neat cats too. I'm
          on <a href="https://github.com/Alanaktion">GitHub</a>,{" "}
          <a href="https://bsky.app/profile/alan.pizza">Bluesky</a>,{" "}
          <a href="https://keybase.io/alanaktion">Keybase</a>, and{" "}
          <a href="https://last.fm/user/Alanaktion">Last.fm</a>, and probably
          other places too.
        </p>
      </section>
      ...
      <section className="prose-all prose-indigo mx-auto lg:mb-12 lg:rotate-2 shadow-layered-light bg-white dark:shadow-layered-dark dark:bg-slate-800 px-6 py-4 lg:px-8 rounded-xl lg:rounded-3xl">
        <p>
          I also run a <a href="https://alan.pizza">pizza blog</a>! I eat a lot
          of pizza (like, <i>too much</i> pizza), so I decided to document it.
          For a while when I first started the blog, I posted every time I ate
          pizza, but since that's often daily, I now only post new pizzas that I
          try for the first time. I try to give a simple review of each one, and
          while I find detailed food critique weird and difficult to do well, I
          enjoy writing the brief summary and posting the photos.
        </p>
        <div className="sm:flex gap-4 lg:gap-6 items-center">
          <picture>
            <source
              type="image/avif"
              srcset="https://alan.pizza/img/7xXDVJxNyD-800.avif 800w"
            />
            <source
              type="image/webp"
              srcset="https://alan.pizza/img/7xXDVJxNyD-800.webp 800w"
            />
            <img
              className="rounded-sm mx-auto sm:w-64 my-2! text-sm aspect-[4/3]"
              loading="lazy"
              decoding="async"
          ...
          <div>
            <p>
              My current favorite pizza is the Little Caesar’s Slices-N-Stix.
              Half-pizza, half-Italian Cheese Bread!
            </p>
            <p>
              <a
