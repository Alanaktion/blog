...
export async function loadTokenizer(modelFolder = "model") {
  ...
  try {
    ...
    console.warn("Could not resolve eos_token_id; generation will run to maxNewTokens.", err);
  }
